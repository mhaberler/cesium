...
function main() {
  ...
  // This comes from thermal.kk7.ch - Michael v Känel's service
  var thprovider = new WebMapTileServiceImageryProvider({
    url:
      "https://thermal.kk7.ch/tiles/{TileMatrixSet}/{TileMatrix}/{TileRow}/{TileCol}.png?src=blog.mah.priv.at",
    layer: "skyways",
    style: "default",
    maximumLevel: 12,
    tileMatrixSetID: "skyways_all",
  ...
  try {
    ...
    var layer = imageryLayers.addImageryProvider(thprovider);
    thprovider.readyPromise.then(function () {
      //debugger;
