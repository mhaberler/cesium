...
var czml = [
...

  {
    ...
    // // https://groups.google.com/g/cesium-dev/c/q01DY3kPxtg
    // orientation:{
    //     interpolationAlgorithm: "LINEAR",
    ...
    //       1000, 0.309688526062018, -0.0592870464529779, -0.945283886004075, 0.0837641797515638,
    //         2035, 0.15524757622990795, -0.06613430791377527, -0.9841132393764626, 0.05518673278488507

    //       // 0    ,0,0,0,1, //(assuming x,y,z,w) wings level, heading due east
    //       // 120  ,0,0.7071,0,0.7071, //change heading to due south
    //       // 240  ,0,0,0,1, //back to start position
    //       // 360  ,0.7071,0,0,0.7071, //heading east, nose vertical up
    //       // 1000 ,0.7071,0,0,-0.7071, //heading east, nose vertical down
    //       // 2035 ,0,0,0,1, //back to start
    //     ]
    // },
...
function main() {
  ...
  var builtin = 1; // endUserOptions.builtin;
  if (builtin) {
